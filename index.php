...
<html lang="en">
<head>
	<title>Losantos Car Rental System</title>
	<meta charset="utf-8">
...
<body>
		...
		<div class="wrapper">
			...
			?>
				<li>
					...
					<span class="price"><?php echo 'Ksh.'.$rws['hire_cost'];?></span>
	...
	<footer>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> Losantos Car Rental System - Brought To You By Lichuma Ramsley </a>
		</div>
	</footer><!--  end footer  -->
